...
{
    public class RefCheckEXPCheck : IRefCheckCreditCheck
    {
        ...
        public RefCheckEXPCheck(string CheckKey, string EnquiryReasonCode, string EnquirerName, string EnquirerContactNumber)
        {
